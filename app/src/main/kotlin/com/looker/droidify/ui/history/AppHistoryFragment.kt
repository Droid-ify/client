...
@AndroidEntryPoint
class AppHistoryFragment : ScreenFragment() {

    private val viewModel: AppHistoryViewModel by viewModels()

    private lateinit var recyclerView: RecyclerView
    private lateinit var recyclerViewAdapter: AppHistoryFragmentAdapter
    ...
    override fun onCreateView(
        ...
        val view = fragmentBinding.root.apply {
            ...
            content.addView(
                RecyclerView(content.context).apply {
                    ...
                    recyclerViewAdapter =
                        AppHistoryFragmentAdapter(
                            onProductClick = { mainActivity.navigateProduct(it) }
                        )
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            repeatOnLifecycle(Lifecycle.State.CREATED) {
                launch {
                    viewModel.historyApps.collect { apps ->
        ...
        toolbar.title = getString(R.string.app_history)
        return view
    }
