...
import com.looker.droidify.utility.common.extension.scrollbarThumb
import com.looker.droidify.utility.common.extension.scrollbarTrack
...
class RecyclerFastScroller(private val recyclerView: RecyclerView) {
    ...
    private val thumbDrawable = recyclerView.context.scrollbarThumb
    private val trackDrawable = recyclerView.context.scrollbarTrack
    private val minTrackSize = with(recyclerView) { 16.dp }
